			...
			<div id="formDiv" >
				<form action="Register" name="Form02" method="post" >
					<table>
						<tr>
							<td>账&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;号</td>
							<td><input type="text" id="user" name="userid" placeholder="输入长度不能小于3" onkeydown="return nameOnly()" onblur="checkLength(this)" /> </td>
						...
						<tr>
							<td>密&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;码</td>
							<td><input type="password" id="password" name="password" placeholder="输入长度不能小于3" onblur="checkLength(this)" /> </td>
							<td><span id="pwTip"></span></td>
						</tr>
						<tr>
							<td>确认密码</td>
							<td><input type="password" id="checkpw" placeholder="再次输入密码" onblur="checkpww(this)" /> </td>
							<td><span id="checkpwTip"></span></td>
						</tr>
						<tr>
							<td>电子邮箱</td>
							<td><input type="email" name="email" onblur="checkEmail(this)" /> </td>
							<td><span id="emailTip"></span></td>
						</tr>
						<tr>
							<td>手机号码</td>
							<td><input type="text" name="phonenum" maxlength="11" onkeydown="return numOnly()" /> </td>
						</tr>
						<tr>
							<td colspan="3">
